...
_DATABASE_NAME = 'The VOC2007 Database'
_CLASS = 'person'
...
_SAVE_FILE = '/home/ytt/misc/ytt/下载/datasets/Tencent_Traffin_Sign_DataSets/data/marks/XML_FILE'
...
def createXMLFile(attrs, width, height, filename):
    ...
    # filename节点
    createChildNode(doc, 'filename', attrs['name'], root_node) ##图片名称
    # source节点
    ...
    # owner的子节点
    createChildNode(doc, 'flickrid', 'supershoppertoo', owner_node)
